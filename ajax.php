...
//all form ok
            ...
            if ($h == 1) {
                ...
                $div = '<div class="ui-g">
                        <div class="ui-g-6">
                        <p><b>' . ($num - 1) . '. Alszervezet adatai (csoporttag)</b></p>
...
<div class="ui-g">
    <div class="ui-g-12">
        ...
        foreach ($cart as $c) {
            ...
            //for an existing organization does not count on the main organization
            ...
            $msg .= '
                <td align="right">' . number_format(($price * 12), 0, ',', ' ') . ' Ft + Áfa/Év</td>
                ';
            $msg .= '
                <td align="right">';
...
<div class="ui-g">
    <div class="ui-g-12">
        ...
        $msg .= '
                ...
                ';
        $msg .= '
                <td align="right"><b>' . number_format($all, 0, ',', ' ') . ' Ft + Áfa/Év</b></td>
                ';
        $msg .= '
            </tr>
            ';
...
'" . $c['type'] . "'
            ...
            $mail->Subject = 'Sikeres regisztráció - ' . $this->config->item('title');
...
//unique personal data type add
    function updtAdd()
    {
        $msg = '
<tr>
    <td width="25%">
        <input type="text" name="name_upd[]" value="" class="form-control form-control-sm"  maxlength="255" placeholder="Name">
    </td>
    <td><input type="number" min="0" name="store_time_upd[]" value=""
               class="form-control form-control-sm" placeholder="Expiration date"></td>
...
//group bid suborganization add
    function AjCsopAdd()
    {
        ...
        if ($this->input->post('add')) {
            $content = '
<div class="ui-g">
    <div class="ui-g-2 ui-sm-12">' . $this->input->post('add') . '. Organization data</div>
    <div class="ui-g-3 ui-sm-12">
        <input type="text" name="orgName[]"
               value=""
               class="ui-inputfield"
               placeholder="' . ($this->input->post('add') + 1) . '. Organization name">
    </div>
    <div class="ui-g-3 ui-sm-12">
        <select name="type[]"
                class="ui-selectonemenu">
    ...
    function lacontact()
    {
        if ($this->input->post('name')) {
            ...
            $mailla->Subject = 'GDPReg jogi tanácsadás érdeklődés - ' . $this->config->item('title');
    ...
    <tr>
        <td width="650" align="left" valign="top">
            <table cellpadding="0" cellspacing="0" border="0" width="650"
                ...
                <tr>
                    ...
                    <td width="600" align="left" valign="top"
                        ...
                        <p><b>Tisztelt ' . $this->config->item('legal_name') . '!</b></p>

                        <p>Az alábbi szervezet érdeklődik a lent felsorolt témakör(ök)ben. Kérjük vegyék fel velük a kapcsolatot.</p>
            ...
            if ($this->input->post('la1') == 1) {
                $mailla->Body .= '<li>Jogi tanácsadás</li>';
            }
            if ($this->input->post('la2') == 1) {
                $mailla->Body .= '<li>GDPR felkészítés</li>';
            }
            if ($this->input->post('la3') == 1) {
                $mailla->Body .= '<li>DPO szolgáltatás</li>';
            }
...
//last item delete from cart array
    function dcse()
    {
...
//system usage contract generation
    function suaGen()
    {
    ...
    function mentAct()
    {
        if ($this->input->post('id')) {
            ...
            if ($q->num_rows() > 0) {
                ...
                $mailla->Subject = 'Sikeres tanácsadói regisztráció - ' . $this->config->item('title');
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="650"
                ...
                <tr>
                    ...
                    <td width="600" align="left" valign="top"
                        ...
                        <p><b>Kedves ' . $row->name . '!</b></p>
                        <p>Köszönjük, hogy visszaküldted a Tanácsadói szerződést, üdvözlünk a GDPReg szoftver tanácsadói között.</p>
                        <p>Küldjük a GDPReg tanácsadói fiókod aktiválásához szükséges linket: <a href="' . base_url('aktivalas/' . $this->encrypt_model->te($row->email)) . '" target="_blank">Fiók aktiválása</a></p>
                        <p>Az aktiválás után hozzáférésed lesz a tanácsadói adminisztrációs felülethez, ahol tudod követni a hozzád tartozó szervezetek regisztrációját, a jutalékokat.</p>
                        <p>A GDPReg szoftver DEMO felületéhez ugyanazzal a belépési adataiddal itt tudsz belépni: <a href="' . $this->config->item('demo') . '">' . $this->config->item('demo') . '</a></p>
                        <p>Ez egy 10 nyilvántartott személyes MIKRO csomag, a tesztelést segítő minta sablonokkal. Funkcionalitása megfelel a szoftverével, de további felhasználó nem rögzíthető benne. Kérjük gyakorold a használatot, jelezd észrevételeidet, segítő javaslataidat, esetleges hibákat, segíts a fejlesztésben, hogy a saját és az ügyfelek munkáját megkönnyíthessük.</p>
                        <p>Hamarosan értesítünk a következő webkonferenciánkról, további anyagokat biztosítunk a felkészüléshez.</p>
                        <p>Bízunk a sikeres együttműködésben,<br>kérdéseid esetén állunk rendelkezésedre:</p>
                        <p>Szűcsné Tóth Éva<br>ügyvezető<br>+36 30 2052384<br><a href="mailto:szucsne.toth.eva@gdpreg.hu">szucsne.toth.eva@gdpreg.hu</a></p>
                        <p>Katonai Zsolt<br>ügyvezető<br>+36 30 9153252<br><a href="mailto:katonai.zsolt@gdpreg.hu">katonai.zsolt@gdpreg.hu</a></p>
                    </td>
                    <td width="25">&nbsp;</td>
                </tr>
            </table>
